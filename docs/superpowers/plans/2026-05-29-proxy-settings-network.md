...
- Create: `specs/puffer-core/208.md`
...
```markdown
# 208 - Provider Proxy HTTP Helper
...
```bash
git add Cargo.toml crates/puffer-core/Cargo.toml crates/puffer-core/lib.rs crates/puffer-core/network.rs specs/puffer-core/208.md
...
- Create: `specs/puffer-cli/111.md`
...
```markdown
# 111 - Provider Proxy Daemon Wiring
...
```bash
git add crates/puffer-cli/src/daemon.rs crates/puffer-cli/src/main.rs specs/puffer-cli/111.md
...
- Create: `specs/puffer-desktop/575.md`
...
```bash
git add apps/puffer-desktop/src/lib/screens/settings/NetworkSettings.svelte apps/puffer-desktop/src/lib/screens/Settings.svelte apps/puffer-desktop/src/lib/mockData.ts specs/puffer-desktop/575.md
